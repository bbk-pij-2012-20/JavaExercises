...
It may be that the more specific exception is written after the less specific one. So it 
will be caught with Exception even though the exception thrown could be a NullPointerException
...
less specific exception. I.e. catch(NullPointerException ex) should go above 
catch(Exception ex) as is shown below*/		

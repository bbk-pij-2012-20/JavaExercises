...
public class Matrix2
{
	...
	private int row;
	private int column;
	private boolean mat2DSym;
	private boolean isTri;
	
	public static void main(String args[])
	{
		Matrix2 m2=new Matrix2(3,4);
//		m.printIt();
		m2.setRow(2,"1,2,3,4");
//		m2.setColumn(1,"10,20,30");
		m2.printIt();
//		String mat2DStr=m2.toString();
//		System.out.println("toString()= "+mat2DStr);
//		m2.prettyPrint();
		m2.findPatts();
	}
	public void findPatts()
	{
		MatrixChecker mc=new MatrixChecker();
		mat2DSym=mc.isSymmetrical(mat2D);
		isTri=mc.isTriangular(mat2D);
		System.out.printf("Matrix is %ssymmetric\n",mat2DSym?"":"not ");
		System.out.printf("Matrix has %sgot a triangle\n",isTri?"":"not ");
	}
